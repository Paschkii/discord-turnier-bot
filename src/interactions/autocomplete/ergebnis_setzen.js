...
// == Hilfsfunktionen ===
// normalisieren (Kleinbuchstaben, Suffixe entfernen)
const norm = (s) => (s || '')
  .toLowerCase()
  .replace(/[⬆⬇]\uFE0F?/g, '')
...
// Gruppe anhand Label finden (Name oder DisplayName)
...
// Prüfen, ob Kampf zu Gruppe gehört (oder wenn keine Gruppe gewählt, immer true)
